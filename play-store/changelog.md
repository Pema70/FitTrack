...
- Ekran główny z kołowym wskaźnikiem postępu kalorii i podsumowaniem makroskładników (białko, tłuszcze, węglowodany)
- Dziennik posiłków: dodawanie, edycja i usuwanie wpisów z automatycznym przeliczaniem kalorii
- Historia posiłków: przeglądanie wpisów z poprzednich dni przy użyciu kalendarza lub strzałek „wczoraj/jutro"
- Przeglądanie i wyszukiwanie przepisów z możliwością filtrowania
- Dodawanie własnych przepisów (nazwa, składniki, opis, kaloryczność, opcjonalne zdjęcie)
